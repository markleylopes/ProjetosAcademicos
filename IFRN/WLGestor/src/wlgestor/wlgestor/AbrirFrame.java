...
for(int i = 0; i<1000; i++){
         if(!(WLGestor.l0[i].equals("#"))){
            if(WLGestor.l0[i].equalsIgnoreCase(busca)){
           
            this.jTextArea1.append(WLGestor.l0[i+1]+"\n");
...
this.addComponentListener(new ComponentAdapter() {    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbrirFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
